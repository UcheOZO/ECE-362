...
src/%.o: ../src/%.s
	...
	@echo $(PWD)
	arm-none-eabi-as -mcpu=cortex-m0 -mthumb -mfloat-abi=soft -I"Z:/workspace/ECE362/LAB1/Utilities" -I"Z:/workspace/ECE362/LAB1/StdPeriph_Driver/inc" -I"Z:/workspace/ECE362/LAB1/inc" -I"Z:/workspace/ECE362/LAB1/CMSIS/device" -I"Z:/workspace/ECE362/LAB1/CMSIS/core" -g -o "$@" "$<"
