...
src/%.o: ../src/%.s
	...
	@echo $(PWD)
	arm-none-eabi-as -mcpu=cortex-m0 -mthumb -mfloat-abi=soft -I"Z:/workspace/ECE362/LAB5/Utilities" -I"Z:/workspace/ECE362/LAB5/StdPeriph_Driver/inc" -I"Z:/workspace/ECE362/LAB5/inc" -I"Z:/workspace/ECE362/LAB5/CMSIS/device" -I"Z:/workspace/ECE362/LAB5/CMSIS/core" -g -o "$@" "$<"
